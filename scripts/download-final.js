// Script final para descargar todos los archivos usando el Worker de la galería
// Usa el event_code correcto: 'uploads'
const fs = require('fs');
const path = require('path');
const https = require('https');
const http = require('http');

console.log('🚀 Descarga Masiva Final - Todos los Archivos');
console.log('=============================================');
console.log('');
...
const config = {
  ...
  eventCode: 'uploads', // Event code correcto encontrado
...
async function getFileList() {
  console.log(`📋 Obteniendo lista de archivos para event_code: ${config.eventCode}...`);
...
if (require.main === module) {
  ...
  if (args.includes('--test')) {
    ...
    console.log('Uso: node download-final.js [opciones]');
    console.log('');
    console.log('Opciones:');
    console.log('  --test     Probar conexión al Worker');
    console.log('  --help     Mostrar esta ayuda');
    console.log('');
    console.log('Este script descarga todos los archivos del bucket usando el event_code "uploads"');
  } else {
    downloadAllFiles();
  }
}
